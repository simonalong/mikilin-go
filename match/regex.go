...
func BuildRegexMatcher(objectTypeFullName string, fieldKind reflect.Kind, objectFieldName string, tagName string, subCondition string, changeTo string, errMsg string) {
	...
	addMatcher(objectTypeFullName, objectFieldName, &RegexMatch{Reg: reg}, errMsg, changeTo, true)
}
